...
pos_append_file = open('./resources/pos_append', 'w+',encoding='latin1')
wa = WA()
...
sa.analyze_text(sentences_file, pos_append_file)
pos_test_file.close()
pos_append_file.close()
pos_test_file = open('./resources/pos_test.txt','a',encoding='latin1')
pos_append_file = open('./resources/pos_append', 'r',encoding='latin1')
pos_test_file.write(pos_append_file.read())
